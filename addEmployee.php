        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="addEmployeeHandel.php" method="POST" >
                    ...
                    <?php unset($_SESSION['errors']); ?>
                            ...
                            <div class="col-5">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="gender">
                                            <option disabled="disabled" selected="selected" name="gender">GENDER</option>
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name='btn_submit'>Submit</button>
                        </div>
                    </form>
                </div>
            </div>
