...
$q=new Queries;
//$emp_names=$q->selectEmpNames();
///
$id=$_GET['id'];
$task=$q->selectTaskById($id);
?>
<header>
		<nav>
			<h1>Company Name</h1>
    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title text-center mb-4">Edit Project Info</h2>
                    <form action="editTaskHandel.php?id=<?php echo $task['emp_id']?>" method="POST" >
                                ...
                                <select name="emp_name">
                                    ...
                                    //*<?php if($emp_names !==[]) { 
                                           //* foreach($emp_names as $emp_name) {?>
                                                <!--<option value="//*<?php echo $emp_name['name'] ?>"><?php echo $emp_name['name'] ?></option>-->
                                    //*<?php }?>
                                </select>
                        ...
                        <?php if($task !==null) { ?>
                            <input class="input--style-1" value="<?php echo $task['task_name'] ?>" type="text"  name="task_name">
                            <?php }?>
                        </div>
                        ...
                        <?php if($task !==null) { ?>
                            ...
                            <textarea class="form-control" name="desc" rows="3"><?php echo $task['descr'] ?></textarea>
                            <?php }?>
                        </div>
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" name='btn_submit' type="submit">Edit Task</button>
                        </div>
                    </form>
                </div>
            </div>
